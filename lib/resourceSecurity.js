const BLOCK_TYPES = new Set([
  ...
  "quote", "reflection", "takeaway", "accordion",
]);
const DATA_KEYS = new Set([
  "title", "subtitle", "image", "ctaLabel", "ctaLink", "text", "variant",
  "verse", "reference", "src", "caption", "position", "imagePosition", "url", "audioUrl",
  "author", "question", "helper", "items", "align", "width", "style", "color",
  "overlay", "height", "layout", "buttonStyle", "imageShape", "imageSize", "background",
  "listStyle",
]);
